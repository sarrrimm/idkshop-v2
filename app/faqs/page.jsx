        ...
        <Accordion type="single" collapsible className="w-full">
          ...
          <AccordionItem value="question-1">
            ...
            <AccordionContent className="text-gray-600 text-sm">
              We either purchase the product from sellers or list it securely on
              an Asset Lock Contract (ALC), ensuring safe transactions for both
              buyers and sellers.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="question-3">
            ...
            <AccordionContent className="text-gray-600 text-sm">
              You can either sell directly to us or list your product under ALC
              for a safer transaction. Contact our team for more details.
            </AccordionContent>
          </AccordionItem>
          ...
          <AccordionItem value="question-5">
            ...
            <AccordionContent className="text-gray-600 text-sm">
              We only accept cash payments for now but we are planning to
              integrate paymeny gateway in future.
            </AccordionContent>
          </AccordionItem>
        </Accordion>
      </div>
